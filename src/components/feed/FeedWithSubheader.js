...
import { InfiniteScroll, SubHeader, ScreenErrorBoundary } from "src/components";
...
class FeedWithSubheader extends Component {
  ...
  render() {
    ...
    const activeSubTabIndex = tabs.findIndex(tab => tab.value === activeSubTab);
      ...
      <ScreenErrorBoundary boundaryName={boundaryNames.FEED}>
        <InfiniteScroll
          ...
          onViewableItemsChanged={
            ViewCountsService.handleFeedViewableItemsChange
          }
          {...restProps}
        />
      </ScreenErrorBoundary>
