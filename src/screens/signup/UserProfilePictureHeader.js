...
//     borderRadius: 70,
//     borderWidth: 3,
//     borderColor: homeisColors.white
//   },
//   addImageButton: {
//     position: 'absolute',
//     bottom: 4,
...
//     height: 40,
//     borderRadius: 20,
//     backgroundColor: homeisColors.green,
//     alignItems: 'center',
...
//           <Text bold size={32} lineHeight={42} color={homeisColors.white} style={styles.headerText}>
//             {title || I18n.t('onboarding.user_profile_header.title', { firstName })}
//           </Text>
//           <Image source={images.chat.hey} style={styles.headerIcon} />
//         </View>
//         <Text size={20} lineHeight={30} color={homeisColors.white} style={styles.headerText}>
...
//               <AwesomeIcon name="camera" weight="solid" size={18} color={homeisColors.white} onPress={this.handleAddImage} style={styles.addImageBtn} />
//             </View>
//           ) : null}
//         </TouchableOpacity>
//       </View>
...
//     analytics.actionEvents.onboardingClickedUploadPicture({ userId: user.id, source: 'Browse' }).dispatch();
...
//         editImages({ media: { thumbnail: profileImage, profile: profileImage }, newUser: true });
//         apiCommand('profile.editImage', { imageUrl: profileImage, userId: user.id });
//       }
//     });
//   };
// }
...
// UserProfilePictureHeader = connect(mapStateToProps, mapDispatchToProps)(UserProfilePictureHeader);
