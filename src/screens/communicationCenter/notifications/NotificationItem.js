...
import { markAsRead } from "src/redux/notifications/actions";
import {
  View,
  Text,
  Avatar,
...
import { EntityImagePlaceholder } from "src/components/entity";
...
class NotificationItem extends Component {
  render() {
    ...
    const {
      data: { actors, isRead, payload, eventType, eventAction },
      community,
      userNeighbourhood
    } = this.props;
  ...
  renderTime() {
    ...
    return (
      <Text medium size={11} color={daytColors.placeholderGrey}>
...
// const mapDispatchToProps = { markAsRead };
