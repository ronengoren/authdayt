...
const uiColorDefinitions = {
  [postTypes.STATUS_UPDATE]: daytColors.pinkyDate,
  [postTypes.TIP_REQUEST]: daytColors.seafoamBlue,
  [postTypes.RECOMMENDATION]: daytColors.cerise,
  [postTypes.MEETING]: daytColors.pinkyDate,
  [postTypes.HOME_NOSTALGIC]: daytColors.pinkyDate,
  [postTypes.PACKAGE]: daytColors.golden,
  [postTypes.GUIDE]: daytColors.pumpkinOrange,
  [postTypes.SHARE]: daytColors.pinkyDate,
  ...
  [postTypes.GROUP_ANNOUNCEMENT]: daytColors.pinkyDate,
