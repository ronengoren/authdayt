...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actions.UPDATE_POST: {
      const { id, payload, link, mentionsList, tags } = action.payload;
