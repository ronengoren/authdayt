...
// } from "src/redux/results/actions";
// import { updatePost as updateGroupHighlightedPost } from "src/redux/groups/actions";
// import {
//   likeSinglePost,
//   saveSinglePost,
//   updatePost as updatePostPage,
//   deletePost as deletePostPage
// } from "src/redux/postPage/actions";
// import { likeSuggestedItem } from "src/redux/suggestedItems/actions";
// import { get, isEmpty } from "src/infra/utils";
// import { feedEventTypes } from "src/vars/enums";
...
// export const updatePostMediaGallery = ({
//   postId,
//   mediaGallery
// }) => dispatch => {
//   dispatch({
//     type: UPDATE_POST_MEDIA_GALLERY,
//     payload: { postId, mediaGallery }
//   });
// };
...
//     dispatch(updateResultsPost({ id, payload, link, mentionsList }));
//   }

//   if (!isEmpty(postPage)) {
//     dispatch(updatePostPage({ id, payload, link, mentionsList, tags }));
//   }
// };
