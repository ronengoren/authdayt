...
// import { updateUnseenNotifications } from "/redux/notifications/actions";
// import { updateFriendRequests } from "/redux/friendships/actions";
...
// export const LOADED_APP_SETTINGS = "LOADED_APP_SETTINGS";
...
//         .dispatch();
//       analytics.actionEvents
//         .signup({ success: true, registrationMethod: method })
//         .dispatch();
...
//     analytics.actionEvents
//       .signup({ success: false, failureReason: err.toString() })
//       .dispatch();
//     onError && onError(err);
//   }
// };
...
//   const res = await dispatch(
//     apiQuery({ query: { domain: "auth", key: "getAppSettings" } })
//   );

//   const rawData = res.data.data;
//   dispatch({
//     type: LOADED_APP_SETTINGS,
//     payload: {
//       appSettings: rawData
//     }
//   });
