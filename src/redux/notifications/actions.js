...
// export const UPDATE_UNSEEN_NOTIFICATIONS = 'COMMUNICATIONS/UPDATE_UNSEEN_NOTIFICATIONS';
...
//   const unreadChats = conversations ? conversations.filter((conversation) => conversation.lastMessage && conversation.lastMessage.isUnread).length : 0;
